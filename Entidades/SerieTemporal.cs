...
namespace PPAI_REDSISMICA.Entidades
{
    public class SerieTemporal
    {
        ...
        public SerieTemporal(int id,string condicionAlarma, DateTime fechaHoraInicioRegistroMuestras, DateTime fechaHoraRegistro, string frecuenciaMuestreo, List<MuestraSismica> muestrasSismicas)
        {
            this.id = id;
